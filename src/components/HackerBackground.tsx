...
export function HackerBackground() {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden bg-[#020102]">
      ...
      {/* Camada 2: Matrix Code Rain - Camada Distante (Depth) com Blur */}
      <div className="absolute inset-0 hacker-code-deep opacity-60 blur-[1px]" />
      
      {/* Camada 3: Matrix Code Rain - Camada Próxima (Action) para efeito de script ativo */}
      <div className="absolute inset-0 hacker-code-front opacity-80" />
      
      {/* Camada 4: Ruído Digital Sutil para textura hacker */}
      <div className="absolute inset-0 opacity-[0.015] pointer-events-none" 
           style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")` }} />

      {/* Camada 5: Linhas de Varredura (Scanline) para visual de monitor antigo */}
      ...
      {/* Partículas Digitais Glitch (Glitches discretos) */}
